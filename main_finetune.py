...
def main(args):
    ...
    dataset_train = build_dataset(is_train=True, use_hf=args.use_hf_dataset, is_test=False, args=args)
    dataset_val = build_dataset(is_train=False, use_hf=args.use_hf_dataset, is_test=True, args=args)
